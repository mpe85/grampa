...
[![Kotlin](https://img.shields.io/badge/kotlin-2.4-blue.svg?logo=kotlin&label=Kotlin)](http://kotlinlang.org)
...
dependencies {
    implementation 'com.github.mpe85:grampa:1.7.0'
}
```
...
<dependency org="com.github.mpe85" name="grampa" rev="1.7.0"/>
```
