...
class ParserCreateExceptionTest {

  @Test
  fun create() {
    val cause = RuntimeException()
    val ex1 = ParserCreateException("someMessage")
    val ex2 = ParserCreateException(cause)
    val ex3 = ParserCreateException("someMessage", cause)
