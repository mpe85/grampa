...
class CharPredicateRuleTests : StringSpec({
  "equals/hashCode/ToString" {
    ...
    rule1.toString() shouldBe "CharPredicateRule(predicate=fun java.util.function.Predicate<T>.test(T): kotlin.Boolean)"
    rule2.toString() shouldBe "CharPredicateRule(predicate=fun java.util.function.Predicate<T>.test(T): kotlin.Boolean)"
