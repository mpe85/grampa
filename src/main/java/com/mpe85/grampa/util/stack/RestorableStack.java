...
public interface RestorableStack<E> extends Deque<E> {
	 ...
	 * 
	 * @param down
	 *                the position where the element is inserted, counted downwards beginning at the top of the stack
	 ...
	 * 
	 * @param down
	 *                the position where the element is poked, counted downwards beginning at the top of the stack (i.e.
	 *                the number of elements on the stack to skip).
	 * @param element
	 *                a replacement element
	 * @return the replaced element
